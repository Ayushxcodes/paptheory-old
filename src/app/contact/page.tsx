      ...
      <div className="pt-32 pb-16 px-6 lg:px-8">
        <div className="max-w-6xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold text-black mb-6">
            Get in <span className="text-[#f99216]">Touch</span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2 bg-gray-50 p-10 rounded-2xl">
              ...
              <form className="space-y-8">
                ...
                <Button className="w-full bg-[#f99216] hover:bg-[#e54a1a] text-white py-4 px-6 rounded-lg font-medium transition-colors text-lg">
                  Send Message
                </Button>
              </form>
            </div>
            ...
            <div className="space-y-8 lg:pt-10">
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <div className="w-6 h-6 bg-[#f99216] rounded-full flex items-center justify-center flex-shrink-0 mt-1">
              ...
              <div>
                ...
                <div className="flex gap-4">
                  <a href="#" className="w-10 h-10 bg-[#f99216] rounded-full flex items-center justify-center hover:bg-[#e54a1a] transition-colors">
