...
const PROJECTS = [
  {
    num: "01",
    title: "Gen Z Brand Campaign — Financial Services",
    client: "ICICI Bank India",
    tags: ["Campaign", "Social-First"],
  },
  {
    num: "02",
  ...
  {
    num: "03",
    title: "Brand Experience & Content",
    client: "Tata Motors",
    tags: ["Experiential", "Content"],
  },
];
    ...
    <section className="projects alt bg-white text-gray-900 w-full">
      ...
      <div className="cta-strip bg-orange-500 py-12 w-full">
        <div className="w-full px-6 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          <div className="cta-strip-text font-serif text-2xl md:text-3xl lg:text-5xl text-black">Have a communications<br />challenge?</div>
